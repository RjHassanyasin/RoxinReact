...
export default function Section2() {
    return (
        <div className='h-auto py-10 w-full border-2 border-black flex flex-col md:flex md:flex-row md:flex-wrap md:justify-evenly md:items-center md:content-evenly items-center gap-5'>
